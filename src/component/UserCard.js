    ...
    >
      <CardOverflow
        ...
        sx={{
          height: 250,
          backgroundImage:
            "url(https://miro.medium.com/v2/resize:fit:1400/1*Rf__8xWSTniXUDcGvnC3Hw.jpeg)",
      ...
      >
        <AspectRatio
          ...
          sx={{
            ...
            position: "relative",
            backgroundImage:
              "url(https://media.licdn.com/dms/image/D4D03AQEl8EaEStSxAw/profile-displayphoto-shrink_800_800/0/1702635235545?e=1707955200&v=beta&t=Bro5bbNcQBrK9sB-b4zbC6LiD69BLO-06BJM8NConLs)",
            backgroundSize: "cover",
            zIndex: 30,
          }}
        ></AspectRatio>
      ...
      <Typography
        level="title-lg"
        sx={{ mt: "calc(var(--icon-size) / 2)", fontWeight: "bold" }}
      >
        Öznur Yılmaz
      </Typography>
      <Typography level="body-sm" sx={{ color: "#a33da5", fontWeight: "bold" }}>
