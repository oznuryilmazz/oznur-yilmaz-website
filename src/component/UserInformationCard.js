import { Box, Card, Divider, Stack, SvgIcon, Typography } from "@mui/joy";
  ...
  return (
    <Stack direction="row">
      ...
      >
        ...
        <Divider />
        <Stack direction="row">
          <Stack sx={{ border: "thin solid #00000020" }} padding={5} margin={2}>
            <SvgIcon>
              <svg
            ...
            <Typography fontWeight="bold">Twitch Streaming</Typography>
            <Typography>
              American video live streaming service that focuses on video game
              live streaming.
            </Typography>
          </Stack>
          <Stack sx={{ border: "thin solid #00000020" }} padding={5} margin={2}>
        ...
        <Stack direction="row">
          <Stack sx={{ border: "thin solid #00000020" }} padding={5}>
            <SvgIcon>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
